...
def extend_equation(coefficients_x, variable_list, point):
    equation = 0
    num_terms_per_var = 3  # Cubic equation: cubic, quadratic, linear
...
def extend_predict(coefficients_x, variables):
    equation = 0
    num_terms_per_var = 3
